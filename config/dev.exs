...
config :gojo, GojoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "3uDrDg5dt4ivq3QQcj9TauPVxulz3/PhoKL64QB8Smc5m/XtWAtTdLJ/MZd8ANav",
  watchers: [
...
config :gojo, GojoWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/gojo_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :gojo, dev_routes: true
